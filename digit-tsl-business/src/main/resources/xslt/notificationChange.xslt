...
<xsl:stylesheet version="1.0"
	...
	xmlns:text="java://eu.europa.ec.joinup.tsl.business.xslt.NotificationReportTranslator">
		...
		<fo:root>
			<fo:layout-master-set>
				<fo:simple-page-master master-name="body-even"
					page-width="21.0cm" page-height="29.7cm" margin-top="1.5cm"
					margin-left="1cm" margin-right="1cm" margin-bottom="2cm">
			...
			<fo:page-sequence master-reference="body-even">
				<fo:static-content flow-name="xsl-region-after">
					<fo:block font-size="7pt" text-align="right"
						padding-bottom="5pt" padding-top="3pt">
	...
	<xsl:template name="content">
		...
		<fo:block padding-top="15pt" font-size="9pt">
			<xsl:value-of
				select="text:translatePointersIntro(@memberState)" />
		</fo:block>
	</xsl:template>

	<xsl:template name="intro">
		<fo:block text-align="center" font-size="9pt" color="#b3b3cc"
			padding-bottom="5pt">
			<xsl:value-of select="@docID" />
		</fo:block>
		...
		<fo:table page-break-after="avoid">
			...
			<fo:table-body>
				<fo:table-row border="solid black"
					...
					<fo:table-cell>
						<fo:block padding="5pt" text-align="center"
							font-size="11pt" font-weight="bold">
							<fo:inline font-weight="bold">
								<xsl:value-of
									select="text:translate('pdf.notification.title')" />
							</fo:inline>
						</fo:block>
					</fo:table-cell>
				</fo:table-row>
		...
		<fo:block font-size="9pt" padding="0pt" padding-top="5pt">
				...
				<fo:table-body>
					<fo:table-row>
						<fo:table-cell>
							<fo:block font-weight="bold">
								<xsl:value-of
									select="text:translate('pdf.notification.territory')" />
							</fo:block>
						</fo:table-cell>
						<fo:table-cell>
							<fo:block>
					...
					<fo:table-row>
						<fo:table-cell>
							<fo:block font-weight="bold">
								<xsl:value-of
									select="text:translate('tSchemeOperatorName')" />
							</fo:block>
						</fo:table-cell>
						<fo:table-cell padding-left="0pt">
							<fo:block>
								<fo:table text-align="left">
									<fo:table-column column-number="1"
										column-width="20pt"></fo:table-column>
									<fo:table-column column-number="2"></fo:table-column>
									<fo:table-body>
										<xsl:if test="count(schemeOperatorNames/map)=0">
											<fo:table-row>
												<fo:table-cell>
													<fo:block></fo:block>
												</fo:table-cell>
										...
										<xsl:if test="count(schemeOperatorNames/map)>0">
											<xsl:for-each
												select="schemeOperatorNames/map/entry">
												<fo:table-row>
													<fo:table-cell>
														<fo:block>
					...
					<fo:table-row>
						<fo:table-cell>
							<fo:block font-weight="bold">
								<xsl:value-of
									select="text:translate('pdf.notification.contact')" />
							</fo:block>
						</fo:table-cell>
						<fo:table-cell padding-left="0pt">
							<fo:block>
									...
									<fo:table-body>
										<fo:table-row>
											<fo:table-cell>
												<fo:block>
													<xsl:value-of
														select="text:translate('pdf.notification.contact.name')" />
												</fo:block>
											</fo:table-cell>
											<fo:table-cell>
												<fo:block>
										...
										<fo:table-row>
											<fo:table-cell>
												<fo:block>
													<xsl:value-of
														select="text:translate('pdf.notification.contact.address')" />
												</fo:block>
											</fo:table-cell>
											<fo:table-cell>
												<fo:block>
										...
										<fo:table-row>
											<fo:table-cell>
												<fo:block>
													<xsl:value-of
														select="text:translate('pdf.notification.contact.phone')" />
												</fo:block>
											</fo:table-cell>
											<fo:table-cell>
												<fo:block>
					...
					<fo:table-row>
						<fo:table-cell>
							<fo:block font-weight="bold">
								<xsl:value-of
									select="text:translate('pdf.notification.location.xml')" />
							</fo:block>
						</fo:table-cell>
						<fo:table-cell>
							<fo:block>
					...
					<fo:table-row>
						<fo:table-cell>
							<fo:block font-weight="bold">
								<xsl:value-of
									select="text:translate('pdf.notification.location.pdf')" />
							</fo:block>
						</fo:table-cell>
						<fo:table-cell>
							<fo:block>
			...
			<fo:block padding-top="10pt">
				<fo:table border-collapse="separate"
					border-separation="5pt" border="solid black">
					<fo:table-body>
						<fo:table-row>
							<fo:table-cell>
								<fo:block font-weight="bold">
									<xsl:value-of
										select="text:translate('tAuthorizedUsers')" />
								</fo:block>
							</fo:table-cell>
							<fo:table-cell padding-left="0pt">
						...
						<fo:table-header border="solid black">
							<fo:table-row>
								<fo:table-cell>
									<fo:block font-weight="bold">
										<xsl:value-of
											select="text:translate('tSignature')" />
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
						</fo:table-header>
										...
										<fo:table-body>
											...
											<fo:table-row>
												<fo:table-cell>
													<fo:block>
														<xsl:value-of
															select="text:translate('signature.indication')" />
													</fo:block>
												</fo:table-cell>
												<fo:table-cell>
													<fo:block>
														<xsl:value-of
															select="signatureInformation/indication" />
													</fo:block>
												</fo:table-cell>
											</fo:table-row>
											<!-- Signed By -->
											<xsl:if test="signatureInformation/signedBy!=''">
												<fo:table-row>
													<fo:table-cell>
														<fo:block>
															<xsl:value-of
																select="text:translate('signature.signBy')" />
														</fo:block>
													</fo:table-cell>
													<fo:table-cell>
														<fo:block>
															<xsl:value-of
																select="signatureInformation/signedBy" />
														</fo:block>
													</fo:table-cell>
												</fo:table-row>
											</xsl:if>
											...
											<xsl:if test="signatureInformation/signingDate">
												<fo:table-row>
													<fo:table-cell>
														<fo:block>
															<xsl:value-of
																select="text:translate('signature.signingDate')" />
														</fo:block>
													</fo:table-cell>
													<fo:table-cell>
														<fo:block>
															<xsl:value-of
																select="text:toDateFormat(signatureInformation/signingDate)" />
														</fo:block>
													</fo:table-cell>
												</fo:table-row>
											</xsl:if>
						...
						<fo:table-header border="solid black">
							<fo:table-row>
								<fo:table-cell>
									<fo:block font-weight="bold">
										<xsl:value-of
											select="text:translate('pdf.notification.certificate')" />
									</fo:block>
								</fo:table-cell>
							</fo:table-row>
						</fo:table-header>
					...
					<fo:table-body>
						<fo:table-row>
							<fo:table-cell>
								<fo:block font-weight="bold">
									<xsl:value-of
										select="text:translate('pdf.notification.date.submission')" />
								</fo:block>
							</fo:table-cell>
							<fo:table-cell>
								<fo:block>
						...
						<fo:table-row>
							<fo:table-cell>
								<fo:block font-weight="bold">
									<xsl:value-of
										select="text:translate('pdf.notification.date.application')" />
								</fo:block>
							</fo:table-cell>
							<fo:table-cell>
								<fo:block>
	...
	<xsl:template name="table">
				...
				<fo:table-row border="solid black"
					...
					<fo:table-cell number-columns-spanned="2">
						<fo:block padding="5pt" margin-left="3pt">
							<fo:inline font-weight="bold">
								<xsl:value-of
									select="text:translate('pdf.changes')" />
							</fo:inline>
						</fo:block>
					</fo:table-cell>
				</fo:table-row>
		...
		<fo:block font-size="9pt" padding-top="15pt">
			<fo:block>
				<xsl:value-of
					select="text:translateTableIntro(@memberState)" />
			</fo:block>
			<fo:block padding-top="10pt">
						...
						<fo:table-row font-weight="bold">
							<fo:table-cell border="solid black"
								...
								<fo:block padding="5pt" margin-left="1pt">
									<xsl:value-of
										select="text:translate('pdf.notification.table.change')" />
								</fo:block>
							</fo:table-cell>
							<fo:table-cell border="solid black"
								background-color="#E0E0E0">
								<fo:block padding="5pt" margin-left="1pt">
									<xsl:value-of
										select="text:translateTableSecondColumn(@memberState)" />
								</fo:block>
							</fo:table-cell>
						</fo:table-row>
					</fo:table-header>
			...
			<fo:block padding-top="10pt">
				<xsl:value-of
					select="text:translate('pdf.notification.table.outro')" />
			</fo:block>
		</fo:block>
	</xsl:template>

	<xsl:template name="checkInfo"
		match="pointersToOtherTslChecks">
	...
	<xsl:template name="tablecheck">
		...
		<fo:table page-break-after="avoid" margin-top="10pt">
			...
			<fo:table-body>
				<fo:table-row border="solid black"
					...
					<fo:table-cell number-columns-spanned="2">
						<fo:block padding="5pt" margin-left="3pt">
							<fo:inline font-weight="bold">
								<xsl:value-of
									select="text:translate('pdf.summary')" />
							</fo:inline>
						</fo:block>
					</fo:table-cell>
				</fo:table-row>
				<xsl:if test="/root/@numberOfCheck =0">
					<fo:table-row>
						<fo:table-cell border="solid black"
							number-columns-spanned="2" margin-left="3pt" padding="2pt">
							<fo:block font-size="7pt">
								<xsl:value-of
									select="text:translate('tNotification.checkSuccess')"></xsl:value-of>
							</fo:block>
						</fo:table-cell>
					</fo:table-row>
				</xsl:if>
				<xsl:if test="/root/@numberOfCheck > 0">
					...
					<fo:table-row font-size="7pt">
						<fo:table-cell border="solid black"
							...
							<fo:block>
								<xsl:value-of
									select="text:translate('pdf.warning')" />
							</fo:block>
						</fo:table-cell>
						<fo:table-cell border="solid black"
							margin-left="1pt" padding="2pt">
		...
		<xsl:if test="grouped-checks != ''">
			<fo:table border="solid black" text-align="center"
				...
				<fo:table-body>
					<fo:table-row border="solid black" font-weight="bold"
						background-color="#E0E0E0" page-break-after="avoid">
						<fo:table-cell border="solid black"
							text-align="left" padding="2pt" margin-left="1pt">
	...
	<xsl:template name="locationId">
		<xsl:variable name="first"
			select="substring-after(tlLocationId, '||')" />
		...
		<xsl:if test="contains($location, '||')">
			...
			<fo:block margin-left="10" vertical-align="top">
				...
				<xsl:choose>
					<xsl:when test="contains($second, '||')">
						<xsl:value-of
							select="substring-before($second, '||')" />
					</xsl:when>
					<xsl:otherwise>
			...
			<xsl:if test="contains($locationSecond, '||')">
				<xsl:variable name="third"
					select="substring-after($locationSecond, '||')" />
				...
				<xsl:if test="contains($locationThird, '||')">
					<xsl:variable name="four"
						select="substring-after($locationThird, '||')" />
					...
					<xsl:if test="contains($locationFour, '||')">
						<xsl:variable name="five"
							select="substring-after($locationFour, '||')" />
