 ...
 *         &lt;element ref="{http://www.etsi.org/19162/conformanceChecker}Transforms" minOccurs="0"/>
 *       &lt;/sequence>
...
@XmlType(name = "", propOrder = { "check", "transforms" })
@XmlRootElement(name = "Reference", namespace = "http://www.etsi.org/19162/conformanceChecker")
public class Reference {

    @XmlElement(name = "Check", namespace = "http://www.etsi.org/19162/conformanceChecker")
    protected List<Check> check;
    @XmlElement(name = "Transforms", namespace = "http://www.etsi.org/19162/conformanceChecker")
    ...
    /**
     * Obtient la valeur de la propriete transforms.
     * 
    ...
    /**
     * Definit la valeur de la propriete transforms.
     * 
     * @param value
