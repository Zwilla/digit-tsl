...
public class TLQServiceTypeUtils {
    ...
    /**
     * Loop through service additionnal service extension and set service type depends on aSi
     * Set undefined value when no aSi detected
     *
     * @param service
     ...
     * @return
     */
    private static Set<String> loopExtension(List<TLServiceExtension> extensions, ServiceLegalType undefinedValue, ServiceLegalType eSigValue, ServiceLegalType eSealValue,
            ServiceLegalType wsaValue) {
