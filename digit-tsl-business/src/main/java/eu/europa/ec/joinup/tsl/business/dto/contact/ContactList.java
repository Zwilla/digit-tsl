...
@XmlType(name = "", propOrder = { "tlsoContact" })
...
public class ContactList {
     ...
     * present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the tlsoContact property.
     *
     * <p>
     ...
     *
     * <p>
     * Objects of the following type(s) are allowed in the list {@link ContactList.TLSOContact }
     *
     *
     */
    public List<ContactList.TLSOContact> getTLSOContact() {
        if (tlsoContact == null) {
            tlsoContact = new ArrayList<>();
        }
     ...
     */
    @XmlAccessorType(XmlAccessType.FIELD)
    @XmlType(name = "", propOrder = { "name", "postalAddress", "phoneNumber", "submissionDate", "territory", "electronicAddress" })
    public static class TLSOContact {
        ...
        public TLSOContact() {
            ...
            this.electronicAddress.uri = new ArrayList<>();
        }
         ...
         *
         * @return possible object is {@link ContactList.TLSOContact.ElectronicAddress }
         *
         */
         ...
         *
         * @param value
         *            allowed object is {@link ContactList.TLSOContact.ElectronicAddress }
         *
         */
        ...
        public static class ElectronicAddress {
             ...
             * will be present inside the JAXB object. This is why there is not a <CODE>set</CODE> method for the uri property.
             *
             * <p>
             * For example, to add a new item, do as follows:
             * 
