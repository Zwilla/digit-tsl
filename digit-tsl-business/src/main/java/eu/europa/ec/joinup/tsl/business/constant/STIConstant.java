...
public class STIConstant {
    ...
    public static final List<String> qNonTrustServices = new ArrayList<>(
            Arrays.asList(caPKC, ocsp, crl, tsa, tsaTssQC, tsaTssAdesQaQES, eds, edsRem, pses, adesValidation, adesGeneration));
