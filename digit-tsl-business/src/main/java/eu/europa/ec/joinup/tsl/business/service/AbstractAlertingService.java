...
public abstract class AbstractAlertingService {
    ...
    public abstract void sendNewUserAlert(List<String> ecasIDs);

    public abstract void sendAccessListAlert();
     ...
     */
    public abstract void sendNotificationToTLSO(NotificationStatus status, DBNotification dbNotif, DSSDocument pdfDoc,
            List<String> contactListDeleted);
     ...
     * @param pdfDoc
     */
    public abstract void sendNotificationToLOTLSO(NotificationStatus status, DBNotification dbNotif, DSSDocument pdfDoc);
     ...
     * @param nbTrustedList
     */
    public abstract void sendRetentionJobReport(int nbDraftStore, int nbTrustedList);
    ...
    public abstract String getContactListForContent(String cc);

    public abstract List<String> getNotificationContact(DBNotification dbNotif, List<String> contactDeleted);
