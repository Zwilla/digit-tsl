...
@XmlType(name = "", propOrder = { "versionIdentifier", "toolIdentifier", "notificationIdentifier", "schemeContact", "pointersToOtherTSL",
		"submissionDate", "effectDate", "contactDeleted", "users" })
