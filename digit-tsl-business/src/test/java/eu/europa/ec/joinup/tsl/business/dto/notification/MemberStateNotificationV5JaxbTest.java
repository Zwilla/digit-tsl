...
public class MemberStateNotificationV5JaxbTest extends AbstractSpringTest {
	...
	public void testMarshall() throws Exception {
		...
		if (unmarshall.getSchemeInformation().getPointersToOtherTSL().getOtherTSLPointer() != null) {
			notification.setMpPointer(
					new TLPointersToOtherTSL(0, "test", unmarshall.getSchemeInformation().getPointersToOtherTSL().getOtherTSLPointer().get(0)));
		}
		...
		MemberStateNotificationV5 msNotification = TLNotificationMapper.mapDTONotificationToXMLNotificationObj(notification, "notification identifier",
				contactDeleted);
