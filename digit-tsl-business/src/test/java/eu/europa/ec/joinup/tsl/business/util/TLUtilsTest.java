...
public class TLUtilsTest {
	...
	public void compareDigestOfDifferentEncoding() throws IOException {
		ByteArrayInputStream contentUtf8 = new ByteArrayInputStream(
				FileUtils.readFileToByteArray(new File("src/test/resources/encoding/lotl_utf-8.xml")));
		ByteArrayInputStream contentUtf8WithoutBom = new ByteArrayInputStream(
				FileUtils.readFileToByteArray(new File("src/test/resources/encoding/lotl_utf-8-sansbom.xml")));
