...
public class SignatureUtil {
	...
	public static XAdESSignatureParameters getSignatureParams(GetCertificateResponse certificateResponse,
			DSSDocument doc) {
		XAdESSignatureParameters params = new XAdESSignatureParameters();

		CertificateToken signingCertificate = DSSUtils
				.loadCertificateFromBase64EncodedString(certificateResponse.getCertificate());
		...
		// SigningCertificateV2 (false => old standard 119612 / true => new standard
		// 319132)
	...
	public static SignatureRequest getToBeSigned(GetCertificateResponse certificateResponse,
			XAdESService signatureService, DSSDocument doc, XAdESSignatureParameters params) {
