...
public class AdditionalInformationTypeV5
    implements Serializable
{

    private final static long serialVersionUID = 1L;
    @XmlElements({
        @XmlElement(name = "TextualInformation", type = MultiLangStringTypeV5 .class),
        @XmlElement(name = "OtherInformation", type = AnyTypeV5 .class)
    })
